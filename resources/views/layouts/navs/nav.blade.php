<!--Navbar-->
<nav class="fixed top-0 z-50 w-full border-b border-gray-200 dark:bg-gray-700 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    ...
                    <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
                        <img src="{{ asset('storage/img/Logo.jpg') }}" class="h-8 mr-3 rounded-full" alt="FlowBite Logo" />
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">ProjectZero</span>
                    </a>
            </div>
            ...
            <div class="flex items-center">
                <div class="flex items-center ml-3">
                    ...
                    <div>|</div>
                    <div class="px-3 ">
                        <button type="button" class="flex text-sm  dark:text-gray-300 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                    ...
                    <div class="z-50 hidden text-base list-non  divide-y bg-white divide-gray-100 rounded shadow dark:bg-gray-800 dark:divide-gray-600 dark:rounded" id="dropdown-user">
                        <div class="px-4 py-3 dark:bg-gray-800 dark:divide-gray-600" role="none">
                        ...
                        <ul class="py-1 dark:bg-gray-800 dark:divide-gray-600" role="none">
                            <li>
                                <a href="{{ route('users.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">User Management</a>
                            </li>
                            <li>
                                <a href="{{ route('roles.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Role Management</a>
                            </li>
                            <li>
...
<!--SideBar-->
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full  border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" style="padding-top: 50px" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-300 dark:bg-gray-800 ">
        ...
        <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
            ...
            <p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
               Announcement Example Announcement Example Announcement Example
            </p>
